...
namespace GaleriaOnline.WebApi.Controllers
{
    ...
    public class ImagemController : ControllerBase
    {
        ...
        {
            if (dto.Arquivo == null || dto.Arquivo.Length == 0 || String.IsNullOrEmpty(dto.Nome))
            {
                return BadRequest("Deve ser enviado o nome de uma imagem.");
            }
            ...
            using (var stream = new FileStream
                (caminhoCompleto, FileMode.Create))
            {
